...
models <- lapply(1:length(formulas), 
                 function(i) {
                   ...
                   save(model, file = paste0("D:/malaria_hainan/output/pf/", lab[i],".RData"))})
...
{
  load(paste0("D:/malaria_hainan/output/pf/",lab[i],".RData"))
...
fwrite(table1, file = "D:/malaria_hainan/figs/table_pf01.csv", quote = FALSE, 
       row.names = FALSE) 
...
fwrite(table1, file = "D:/malaria_hainan/figs/table_pf02.csv", quote = FALSE, 
       row.names = FALSE) 
